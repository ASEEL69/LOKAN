...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@KIANTHON "))
...
async def _(event):
    ...
    joinu = await sython(JoinChannelRequest('KIANTHON '))
...
async def _(event):
      await event.reply("""السـورس يعمـل | 𝐾𝐼𝐴𝑁𝙏𝙝𝙤𝙣
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
قناة السورس : https://t.me/KIANTHON 
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)
